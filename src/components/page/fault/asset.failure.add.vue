  ...
  methods: {
    ...
    echoTypeInfo (data) {
      ...
      if (this.infoQueryObj.repairType === '厂家') {
        ...
        this.imgObj.reportImg1 = JSON.parse(JSON.stringify(json.imgArr))
        this.filelistObj.reportList1 = JSON.parse(JSON.stringify(json.imgArr))
        this.imgObj.reportImg2 = JSON.parse(JSON.stringify(json.serviceImgArr))
        this.filelistObj.reportList2 = JSON.parse(JSON.stringify(json.serviceImgArr))
        delete json.serviceImgArr
        delete json.serviceImgArr
      }
